//
//  KindZTableViewController.swift
//  TTDD
//
//  Created by Macintosh HD on 24/10/19.
//  Copyright © 2019 Macintosh HD. All rights reserved.
//

import UIKit

struct DescricaoXmlKindZ {
    var id:Int
    var grupo:String
    var kind:String
    var assunto:String
...
class KindZTableViewController: UITableViewController, XMLParserDelegate {

    var elementName: String = String()
    var descricao:[String]=[]
    var descricoes: [DescricaoXmlKindZ]=[]
    var id:  Int=Int()
    ...
    override func viewDidLoad() {
        ...
        print("KindZ - " + String(proxima_tela))
        
        let longPress = UILongPressGestureRecognizer(target: self, action: #selector(KindZTableViewController.longPress(sender:)))
        ...
        if sender.state == UIGestureRecognizer.State.began {
            ...
            if tableView.indexPathForRow(at: touchPoint) != nil {
                ...
                if (fase_corrente1=="" && fase_intermediaria1=="" &&
                    ...
                    self.performSegue(withIdentifier: "segueZToTemporal", sender: self)
                }
            }
        }
    }
    ...
    func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        if elementName == "row" {
            let row = DescricaoXmlKindZ(id: id, grupo:grupo, kind: kind, assunto:assunto, fase_corrente:fase_corrente, fase_intermediaria: fase_intermediaria,
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celulaReusoKindZ", for: indexPath)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier=="segueToKindM"{
        ...
        if segue.identifier=="segueZToTemporal"{
            //print("entrei no segueZToTemporal")
