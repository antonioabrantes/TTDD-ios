...
class KindSTableViewController: UITableViewController, XMLParserDelegate {

    var elementName: String = String()
    var descricao:[String]=[]
    var descricoes: [DescricaoXmlKindS]=[]
    var id:  Int=Int()
    ...
    override func viewDidLoad() {
        ...
        print("KindS - " + String(proxima_tela))
        ...
        if sender.state == UIGestureRecognizer.State.began {
            ...
            if tableView.indexPathForRow(at: touchPoint) != nil {
                ...
                if (fase_corrente1=="" && fase_intermediaria1=="" &&
                    ...
                    self.performSegue(withIdentifier: "segueSToTemporal", sender: self)
                }
            }
        }
    }
    ...
    func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        if elementName == "row" {
            let row = DescricaoXmlKindS(id: id, grupo:grupo, kind: kind, assunto:assunto, fase_corrente:fase_corrente, fase_intermediaria: fase_intermediaria,
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "celulaReusoKindS", for: indexPath)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier=="segueToKindG"{
        ...
        if segue.identifier=="segueSToTemporal"{
