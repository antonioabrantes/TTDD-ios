//
//  OnosSTableViewController.swift
//  TTDD
//
...
class OnosSTableViewController: UITableViewController, XMLParserDelegate {

    var elementName: String = String()
    var descricao:[String]=[]
    var descricoes: [DescricaoXmlOnosS]=[]
    //var elementName: String=String()
    var id:  Int=Int()
    ...
    func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        if elementName == "row" {
            let row = DescricaoXmlOnosS(id: id, grupo:grupo, kind: kind, assunto:assunto, subassunto:subassunto, indice:indice,proximo:proximo)
            ...
            if indice==proxima_tela{
                ...
                print("densidade= ")
                print(densidade)
                print("widthspS= "+String(widthsp)+" intervalo= "+String(intervalo))
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celulaReusoOnosS", for: indexPath)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier=="segueToOnosG"{
            if let indexPath=tableView.indexPathForSelectedRow {
                let grupo = array_classes[indexPath.row]
                if (grupo == ""){
                    let tableViewControllerDestino = segue.destination as! OnosGTableViewController
        ...
        if segue.identifier=="segueSToGruposPesquisa"{
            if let indexPath=tableView.indexPathForSelectedRow {
                ...
                print("prepare segueSToGruposPesquisa "+String(proximo1))
                tableViewControllerDestino.proxima_tela = proximo1
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        ...
        if (proximo1==0 && grupo1==""){
            ...
            if grupo1 != ""{
                ...
                self.performSegue(withIdentifier: "segueSToGruposPesquisa", sender: self)
                return false
            }
            return true
        }
