//
//  KindMTableViewController.swift
//  TTDD
//
...
class KindMTableViewController: UITableViewController, XMLParserDelegate {

    var elementName: String = String()
    var descricao:[String]=[]
    var descricoes: [DescricaoXmlKindM]=[]
    //var elementName: String=String()
    var id:  Int=Int()
    ...
    override func viewDidLoad() {
        ...
        print("KindM - " + String(proxima_tela))
        
        let longPress = UILongPressGestureRecognizer(target: self, action: #selector(KindMTableViewController.longPress(sender:)))
        ...
        if sender.state == UIGestureRecognizer.State.began {
            ...
            if tableView.indexPathForRow(at: touchPoint) != nil {
                ...
                if (fase_corrente1=="" && fase_intermediaria1=="" &&
                    ...
                    self.performSegue(withIdentifier: "segueMToTemporal", sender: self)
                }
            }
        }
    }
    ...
    func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        if elementName == "row" {
            let row = DescricaoXmlKindM(id: id, grupo:grupo, kind: kind, assunto:assunto, fase_corrente:fase_corrente, fase_intermediaria: fase_intermediaria,
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celulaReusoKindM", for: indexPath)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier=="segueToKindN"{
        ...
        if segue.identifier=="segueMToTemporal"{
            //print("entrei no segueMToTemporal")
