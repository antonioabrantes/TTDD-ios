//
//  OnosZTableViewController.swift
//  TTDD
//
...
class OnosZTableViewController: UITableViewController, XMLParserDelegate {

    var elementName: String = String()
    var descricao:[String]=[]
    var descricoes: [DescricaoXmlOnosZ]=[]
    //var elementName: String=String()
    var id:  Int=Int()
    ...
    func parser(_ parser: XMLParser, didEndElement elementName: String, namespaceURI: String?, qualifiedName qName: String?) {
        if elementName == "row" {
            let row = DescricaoXmlOnosZ(id: id, grupo:grupo, kind: kind, assunto:assunto, subassunto:subassunto, indice:indice,proximo:proximo)
            ...
            if indice==proxima_tela{
                ...
                print("densidade= ")
                print(densidade)
                print("widthspZ= "+String(widthsp)+" intervalo= "+String(intervalo))
                ...
                contador = 42 - (assunto.count + grupo.count)
                if (contador<1) {
                    contador = 20
                }
                str = "."
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "celulaReusoOnosZ", for: indexPath)
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier=="segueZToGruposPesquisa"{
            if let indexPath=tableView.indexPathForSelectedRow {
                ...
                print("prepare segueZToGruposPesquisa "+String(proximo1))
    ...
    override func shouldPerformSegue(withIdentifier identifier: String, sender: Any?) -> Bool {
        ...
        if (proximo1==0 && grupo1==""){
            ...
            if grupo1 != ""{
                ...
                self.performSegue(withIdentifier: "segueZToGruposPesquisa", sender: self)
                return false
            }
            return true
        }
